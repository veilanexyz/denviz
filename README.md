...
1. Написание библиотеки для распределения нормалей на сфере (Татьяна Глушко)
...
Отдельные задачи:
1. Написание библиотеки для генерация гексагональной сетки для сферы. (Исланов Адам)
