...
std::vector<XYPoint> HeatMap::readPointsFromFile(const std::string& filename) const{
...
void HeatMap::Heatmap(const std::string& filename) const {
    std::vector<XYPoint> points = readPointsFromFile(filename);
